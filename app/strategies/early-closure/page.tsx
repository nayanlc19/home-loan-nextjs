...
export default function EarlyClosureStrategy() {
  ...
  return (
    <StrategyAccessGuard strategyNumber={3}>
          ...
          <CardContent>
            <div className="space-y-3">
              <div className="flex justify-between">
                ...
                <span className="font-semibold">₹{Math.round(futureInterestIfContinue).toLocaleString("en-IN")}</span>
              </div>
              ...
              <div className="border-t pt-3 flex justify-between">
                ...
                <span className="text-xl font-bold text-green-600">
                  ₹{(Math.round(futureInterestIfContinue) + taxBenefits.totalBenefit).toLocaleString("en-IN")}
                </span>
              </div>
            </div>
          </CardContent>
